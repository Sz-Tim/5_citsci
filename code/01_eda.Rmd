...
![opfo](../assets/small/opfo_VD.png){width="33%"}
![CORINE](../assets/small/CORINE_VD.png){width="33%"}
![VD](../assets/small/VD_data_VD.png){width="33%"}  
...
![opfo](../assets/small/opfo.png){width="33%"}
![CORINE](../assets/small/CORINE.png){width="33%"}
![VD](../assets/small/VD_data.png){width="33%"}

Zoomed in on the edge of a town (OpFo, CORINE, VD):  
![opfo](../assets/small/opfo_2.png){width="33%"}
![CORINE](../assets/small/CORINE_2.png){width="33%"}
![VD](../assets/small/VD_data_2.png){width="33%"}

Zoomed in close on a couple of points (OpFo, CORINE, VD):  
![opfo](../assets/small/opfo_3.png){width="33%"}
![CORINE](../assets/small/CORINE_3.png){width="33%"}
![VD](../assets/small/VD_data_3.png){width="33%"}  
...
```
```{r habitat_load, echo=F, results='hide', message=F}
...
lc.df %>% st_set_geometry(NULL) %>% 
  ...
  labs(x="", y="Percent of tubes",
       title="Buffers show most difference with points in OpFo (~11%)") +
...
![CORINE](../assets/small/CORINE_urban.png){width="70%"}
...
# Extracted habitat comparison to Vaud
...
# Possible analyses  
- Species accumulation curves  
  - Overall (public vs. structured)  
  - Among habitats (public vs. structured, or focus on one)  
  - Gardens vs. non-gardens (or similar)  
- Species composition  
  - Overall (public vs. structured)  
