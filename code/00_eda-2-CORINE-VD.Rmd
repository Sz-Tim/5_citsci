...
full_obs_props %>%
  ...
  theme(axis.text.x=element_text(angle=270, hjust=0, vjust=0.5)) + 
  labs(x="", y="Proportion of samples", title="Categories with >1% coverage")
...
For several categories, it is not obvious (to me) how they should be re-categorized. These are shown here, with examples of satellite imagery.  
...
Agricultural tilled? non-tilled?  
